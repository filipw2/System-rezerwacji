...
<ul class="w3-navbar w3-white w3-border-bottom w3-xlarge">
  <li><a href="#" class="w3-text-red w3-hover-red"><b><i class="fa fa-map-marker w3-margin-right"></i>Logo</b></a></li>
  <li class="w3-right"><a href="index.php" class="w3-hover-red w3-text-grey"><i class="fa fa-margin-left"></i>Login</a></li>
  <li class="w3-right"><a href="#" class="w3-hover-red w3-text-grey"><i class="fa fa-margin-left"></i>Register</a></li>
...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  <img class="w3-image" src="tropical-island2.jpg" alt="London" width="1500" height="700">
